...
public class SessionsRecord extends UpdatableRecordImpl<SessionsRecord> implements Record3<String, String, LocalDateTime>, ISessions {
    ...
    @Override
    @NotNull
    public SessionsRecord value1(@NotNull String value) {
        setId(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public SessionsRecord values(@NotNull String value1, @Nullable String value2, @Nullable LocalDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public SessionsRecord(@NotNull String id, @Nullable String sessionData, @Nullable LocalDateTime lastAccessed) {
        super(Sessions.SESSIONS);
