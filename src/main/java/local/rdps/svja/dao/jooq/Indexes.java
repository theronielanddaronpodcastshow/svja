...
public class Indexes {
    ...
    public static final Index SESSIONS_LA_INDEX = Internal.createIndex(DSL.name("sessions_la_index"), Sessions.SESSIONS, new OrderField[] { Sessions.SESSIONS.LAST_ACCESSED }, false);
