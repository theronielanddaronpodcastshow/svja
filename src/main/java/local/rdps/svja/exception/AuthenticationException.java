...
/**
 * <p>
 * This exception indicates that there was something wrong with authentication.
 * </p>
 *
 * @author DaRon
 * @since 1.0
...
public class AuthenticationException extends SecurityException {
	private static final String DEFAULT_UI_MESSAGE = "Visit the authenticate URL and add the token provided after authentication into your 'Authorization' header.";
	...
	public AuthenticationException(final String message) {
		super(message, AuthenticationException.DEFAULT_UI_MESSAGE);
	}

	/**
	 * Create a new instance with the passed in message and a ui Message
	 *
	 * @param message
	 */
	public AuthenticationException(final String message, final String uiMessage) {
	...
	public String getExceptionReturnString() {
		return ResultConstants.RESULT_ERROR_AUTHFAILED;
	}
